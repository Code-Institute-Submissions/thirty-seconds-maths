...
document.addEventListener("DOMContentLoaded", function() {
  ...
  /**
   * Calculates result of the math question.
   * Returns the result.
   */
  ...
  /**
   * Checks user answer and increases or decreases the score.
   * Clears the input field after it.
   * Sets cursor back to input field.
   * Checks if the score is equal to 10, if so, displays a message to the user.
   */
